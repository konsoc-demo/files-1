function initData(sLocale) {
	if (window.location.href.indexOf("offline") >= 0) {
		...
		var urlCSV_new_case = "https://cdn.jsdelivr.net/gh/konsoc/konsoc@main/2021.09.13/new_cases.csv";
		var urlCSV_deaths = "https://cdn.jsdelivr.net/gh/konsoc/konsoc@main/2021.09.13/time_series_covid19_deaths_global.csv";
		var urlCSV_vaccinations = "https://cdn.jsdelivr.net/gh/konsoc/konsoc@main/2021.09.13/vaccinations.csv";
	}
	...
	var __lngLocale = apexCurrentLocale;
	...
	function __(sTrns) {
		...
		var r = __lngData[__lngLocale][sTrns] || __lngData['en'][sTrns];
		if (r === undefined)
			console.log('no translation for string "' + sTrns + '" in localeData "' + __lngLocale + '"');
	...
	*/
	function requestRenderData() {
		...
		function formatXaxeLabel(value, timestamp /*, opts*/) {
			...
			var lc= __lngLocale == 'ru' ? 'ru-RU' :
						__lngLocale == 'en' ? 'en-US' :'en-US';
		...
		var chartCovidOptions = {
			...
			chart: {
				locales: _apexLocales,
				defaultLocale: __lngLocale,
